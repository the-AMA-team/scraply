      ...
      <div className="relative text-white bg-zinc-900 h-screen">
        ...
        <div className="relative z-10 p-28 pt-72">
          ...
          <div className="w-2/3 text-zinc-300 pt-2">
            Something never seen before in education. DeepCraft takes
            DeepLearning and makes it simple to understand using a beautiful
            scratch-like user interface. Run custom deep learning models without
            any code as you try to lower your losses and increase your accuracy,
            with each epoch comes triumph!
          </div>
          <button
